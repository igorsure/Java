...
class UF {
     ...
     */
    public UF(int n,int f,int s,int t) {
    ...
    private boolean valid(int rt1, int rt2) {
    	if (F[rt1]+F[rt2]>first) return false;
    	if (S[rt1]+S[rt2]>first) return false;
    	if (T[rt1]+T[rt2]>first) return false;
